...
var Note = function (_React$Component) {
    ...
    function Note(props, state) {
        ...
        var _this = _possibleConstructorReturn(this, (Note.__proto__ || Object.getPrototypeOf(Note)).call(this, props, state));
  ...
  _createClass(NoteList, [{
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { onMouseOver: _this3.onMouseOver, style: styleobj, onMouseOut: _this3.onMouseOut, key: i }));
      }, this);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-d68981ae946fca3795ac.js.map