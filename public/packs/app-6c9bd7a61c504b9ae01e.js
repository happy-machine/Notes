        ...
        Object.defineProperty(_this, 'refresh', {
            ...
            value: function value() {
                setTimeout(function (props) {
                    if (_this.state.color != 'red') {
                        var localOpacity = parseFloat(_this.state.opacity);
                        localOpacity += 0.01;
                        _this.state.opacity > 1.1 ? _this.setState({ opacity: '0' }) : _this.setState({ opacity: localOpacity.toString() });
                    }
                    _this.refresh();
                }, 100);
            }
            ...
            return (
                ...
                this.props.content.split('\\n').map(function (line, key) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'span',
                        { key: key, style: this.state, onMouseOver: this.onMouseOver, onMouseOut: this.onMouseOut },
                        line,
  ...
  _createClass(NoteList, [{
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { style: _this3.state.bind(_this3), onMouseOver: _this3.onMouseOver, onMouseOut: _this3.onMouseOut, key: i }));
      }, this);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-6c9bd7a61c504b9ae01e.js.map