            ...
            return (
                ...
                this.props.content.split('\\n').map(function (line, key) {
                    ...
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'span',
                        { key: key, ref: function ref(fieldEditor1) {
                                _this2.fieldEditor1 = fieldEditor1;
                            }, style: concatStyle, onMouseOver: this.onMouseOver, onMouseOut: this.onMouseOut },
                        line,
  ...
  _createClass(NoteList, [{
    ...
    value: function componentDidMount() {
      ...
      var refresh = function refresh() {
        ...
        setTimeout(function (props) {
          console.log(_this2.reference.state.color);
          if (_this2.reference.state.color != 'red') {
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { style: _this3.state, key: i, ref: function ref(reference) {
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-f15a1a2484a04245790e.js.map