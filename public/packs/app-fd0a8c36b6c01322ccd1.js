...
/* 9 */
/*!**************************************************!*\
  !*** ./app/javascript/packs/components/Note.jsx ***!
  \**************************************************/
...
var Note = function (_React$Component) {
    ...
    function Note(props) {
        ...
        Object.defineProperty(_this, 'format_title', {
            enumerable: true,
            writable: true,
        ...
        _this.state = { value: _this.props.content };
        return _this;
    }
    ...
    _createClass(Note, [{
        ...
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'titles', onClick: this.click, value: this.state.value, onChange: this.handleChange, onBlur: this.handleSubmit },
...
/* 10 */
/*!******************************************************!*\
  !*** ./app/javascript/packs/components/NoteList.jsx ***!
  \******************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(/*! react */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Note__ = __webpack_require__(/*! ./Note */ 9);
...
var NoteList = function (_React$Component) {
  ...
  function NoteList(props) {
    ...
    Object.defineProperty(_this, 'getToken_populateNote', {
      enumerable: true,
      writable: true,
      value: function value() {
        var cookie = document.cookie;
        if (cookie.split('=')[0] == "notes_token") {
          console.log('seing', cookie.split('=')[1]);
          _this.setState({ token: cookie.split('=')[1] }, console.log(_this.state));
        }
      }
    });
    Object.defineProperty(_this, 'populateNotes', {
      enumerable: true,
      writable: true,
      value: function value() {
        fetch('/notes.json?auth=' + _this.state.token).then(function (res) {
          return res.json();
        }).then(function (res) {
  ...
  _createClass(NoteList, [{
    ...
    */
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({ onClick: _this2.props.onNoteSelect, className: 'preview' }, contents, { key: i }));
      }, this);

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'list', children: notes });
    }
  }], [{
    key: 'getDerivedStateFromProps',
    value: function getDerivedStateFromProps(nextProps, prevState) {
...
/* harmony default export */ __webpack_exports__["default"] = (NoteList);

/***/ }),
/* 11 */
/*!********************************************************!*\
  !*** ./app/javascript/packs/components/NoteWindow.jsx ***!
  \********************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var NoteWindow = function (_React$Component) {
    _inherits(NoteWindow, _React$Component);

    function NoteWindow(props) {
        _classCallCheck(this, NoteWindow);

        var _this = _possibleConstructorReturn(this, (NoteWindow.__proto__ || Object.getPrototypeOf(NoteWindow)).call(this, props));

        Object.defineProperty(_this, 'clearWindow', {
            enumerable: true,
            writable: true,
            value: function value() {
        ...
        Object.defineProperty(_this, 'save', {
            ...
            value: function value(_value) {
                _this.props.saveNote(_value);
            }
        });
        Object.defineProperty(_this, 'new', {
            enumerable: true,
            writable: true,
            value: function value() {
                _this.setState({ value: '' });
    ...
    _createClass(NoteWindow, [{
        key: 'render',
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'textarea',
                { value: this.state.value, onChange: this.handleChange, onBlur: this.handleSubmit, className: 'window' },
                this.state.value
            );
        }
    }], [{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_NoteList__ = __webpack_require__(/*! ./components/NoteList */ 10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_NoteWindow__ = __webpack_require__(/*! ./components/NoteWindow */ 11);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    Object.defineProperty(_this, 'noteSelected', {
      enumerable: true,
      writable: true,
      value: function value(note) {
        _this.setState({ selectedNote: note }, function () {});
      }
    });
    Object.defineProperty(_this, 'saveNote', {
      enumerable: true,
      writable: true,
      value: function value(note) {
        if (_this.state.selectedNote.id) {
          _this.serverAction({ path: '/notes/' + _this.state.selectedNote.id + '.json', method: 'PUT', body: JSON.stringify({ content: note }) });
        } else {
          _this.serverAction({ path: '/notes.json', method: 'POST', body: JSON.stringify({ content: note }) });
        }
      }
    });
    Object.defineProperty(_this, 'deleteNote', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.serverAction({ path: '/notes/' + _this.state.selectedNote.id + '.json', method: 'DELETE', body: undefined });
      }
    });
    Object.defineProperty(_this, 'serverAction', {
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(_this, 'newNote', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.clearWindow();
        _this.setState({ selectedNote: {} });
      }
    });
    Object.defineProperty(_this, 'refresh', {
      enumerable: true,
      writable: true,
      value: function value(res) {
        _this.noteListRef.current.populateNotes();
      }
    });
    Object.defineProperty(_this, 'clearWindow', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.windowRef.current.clearWindow();
      }
    });
    Object.defineProperty(_this, 'showArrow', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.arrow = document.getElementById('arrow');
        _this.arrow.classList.toggle("showArrow");
        //this.arrow.classList.toggle("bounceArrow");
      }
    });

    _this.state = { selectedNote: {} };
    _this.noteListRef = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
    _this.windowRef = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
    return _this;
  }
  ...
  _createClass(App, [{
    key: 'render',
    value: function render() {
      return [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_NoteList__["default"], _extends({ key: 'note_list' }, this.state, { onNoteSelect: this.noteSelected, ref: this.noteListRef })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { key: 'arrow', id: 'arrow' }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { key: 'new_note', onClick: this.newNote, className: 'new_note' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'p',
          null,
          'New Note'
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { key: 'trash_note', onClick: this.deleteNote, className: 'trash_note' })
      ), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_NoteWindow__["default"], _extends({ key: 'note_window' }, this.state.selectedNote, { saveNote: this.saveNote, newNote: this.newNote, ref: this.windowRef })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { key: 'notes_logo', onClick: this.showArrow, className: 'notes_logo' })];
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-fd0a8c36b6c01322ccd1.js.map