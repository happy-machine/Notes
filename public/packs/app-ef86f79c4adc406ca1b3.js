        ...
        value: function render() {
            return (
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'textarea',
                    { onClick: this.click, value: this.state.value, onChange: this.handleChange, onBlur: this.handleSubmit },
                    this.props.content
                )
            );
        }
...
var NoteWindow = function (_React$Component) {
    ...
    function NoteWindow(props) {
        ...
        Object.defineProperty(_this, 'swapState', {
            enumerable: true,
            writable: true,
            value: function value(e) {
                _this.setState({ selected: e }, function () {
                    console.log('yo');forceUpdate();
                });
            }
        });
        Object.defineProperty(_this, 'shouldComponentUpdate', {
            enumerable: true,
            writable: true,
            value: function value(nextProps, nextState) {
                console.log('should update?');
                console.log('val', nextState.selected.value);
                if (nextState.selected.value != _this.state.selected.value) {
                    console.log('true');
                    return true;
                } else {
                    return false;
...
var App = function (_React$Component) {
    ...
    Object.defineProperty(_this, 'noteSelected', {
      ...
      value: function value(note) {
        _this.setState({ selectedNote: note }, function () {
          console.log(_this.swapState.current.swapState(note));
        });
        //this.swapstate.current.swapState(note)})

      }
    });

    _this.state = { selectedNote: '' };
    _this.swapState = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createRef();
    return _this;
  }
  ...
  _createClass(App, [{
    key: 'render',
    value: function render() {
      return [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_NoteList__["default"], { onNoteSelect: this.noteSelected }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_NoteWindow__["default"], { ref: this.swapState })];
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-ef86f79c4adc406ca1b3.js.map