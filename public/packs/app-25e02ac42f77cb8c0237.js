    ...
    Object.defineProperty(_this, 'getToken_populateNote', {
      ...
      value: function value() {
        var cookie = document.cookie,
            id,
            token;
        cookie.split(';').forEach(function (piece) {
  ...
  function App(props) {
    ...
    Object.defineProperty(_this, 'getToken_populateNote', {
      ...
      value: function value() {
        ...
        cookie.split(';').forEach(function (piece) {
          ...
          _this.setState({ id: id, token: token });
      ...
      value: function value(args) {
        fetch(args.path, {
          ...
          headers: {
            'Content-Type': 'application/json',
            'X-CSRF-Token': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
            'authentication-token': _this.state.token,
            'user-id': _this.state.id
          },
          body: args.body
        }).then(function (res) {
          _this.refresh(res);
    ...
    Object.defineProperty(_this, 'refresh', {
      ...
      value: function value(res) {
        _this.noteListRef.current.populateNotes(_this.state.token, _this.state.id);
      }
    });
    Object.defineProperty(_this, 'clearWindow', {
      enumerable: true,
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-25e02ac42f77cb8c0237.js.map