...
throw new Error("Module build failed: SyntaxError: Unexpected token (21:35)\n\n  19 | \n  20 |     render () {\n> 21 |         var concatStyle = {opacity = this.props.style.opacity,\n     |                                    ^\n  22 |                             color = this.state.color}\n  23 | \n  24 |         return (\n");
  ...
  _createClass(NoteList, [{
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { style: _this3.state, key: i }));
      }, this);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-7cc7e62e55865870b78f.js.map