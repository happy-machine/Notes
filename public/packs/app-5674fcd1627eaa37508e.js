...
var NoteList = function (_React$Component) {
  ...
  function NoteList(props) {
    ...
    Object.defineProperty(_this, 'getToken', {
      enumerable: true,
      writable: true,
      value: function value() {
        var value;
        ...
        if (document.cookie.split('=')[0] == "notes_token") {
          console.log(item, item.split('=')[1]);
          setState({ token: item.split('=')[1] });
        }
      }
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-5674fcd1627eaa37508e.js.map