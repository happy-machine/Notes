    ...
    Object.defineProperty(_this, 'populateNotes', {
      ...
      value: function value() {
        fetch('/notes.json').then(function (res) {
          ...
          _this.setState({ notes: [{ content: '' }, { content: '' }] });
...
var App = function (_React$Component) {
  ...
  function App(props) {
      ...
      value: function value(note) {
        if (note.length) {
          fetch('/notes.json', {
            ...
            body: JSON.stringify({ content: note, id: _this.state.selectedNote.id })
          }).then(function (res) {
            _this.refresh(res);
          });
        }
    ...
    Object.defineProperty(_this, 'deleteNote', {
      ...
      writable: true,
      value: function value() {
        fetch('/notes/' + _this.state.selectedNote.id + '.json', {
          method: 'DELETE',
          credentials: 'include',
          headers: {
            'Content-Type': 'application/json',
    ...
    Object.defineProperty(_this, 'shake', {
      enumerable: true,
      writable: true,
      value: function value() {
        _this.newNote = document.getElementsByClassName("newNoteWords").classList.add('wow headShake');
        //this.newNote.classList.add('wow headShake')
        console.log(_this.newNote);
      }
    });
  ...
  _createClass(App, [{
    key: 'render',
    value: function render() {
      return [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_NoteList__["default"], _extends({ key: 'note_list' }, this.state, { onNoteSelect: this.noteSelected, ref: this.noteListRef })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { key: 'new_note', onClick: this.newNote, onMouseOver: this.shake, className: 'new_note' },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'p',
          { className: 'newNoteWords' },
          'New Note'
        ),
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-6b674cb90ff4b8bd999d.js.map