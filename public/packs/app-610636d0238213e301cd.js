...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected } (29:97)\n\n  27 |                   \n  28 |                 return (\n> 29 |                     <span key={key} ref={(fieldEditor1) => {this.fieldEditor1 = fieldEditor1;}   style={concatStyle} onMouseOver={this.onMouseOver} onMouseOut={this.onMouseOut}>\n     |                                                                                                  ^\n  30 |                         {line}\n  31 |                         <br/>\n  32 |                     </span>\n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Note__ = __webpack_require__(/*! ./Note */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Note___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__Note__);
  ...
  _createClass(NoteList, [{
    ...
    value: function componentDidMount() {
      ...
      var refresh = function refresh() {
        ...
        setTimeout(function (props) {
          ...
          if (_this2.state.color != 'red') {
            var localOpacity = parseFloat(_this2.state.opacity);
            localOpacity += 0.01;
            _this2.state.opacity > 1.1 ? _this2.setState({ opacity: '0' }) : _this2.setState({ opacity: localOpacity.toString() });
          }
          refresh();
        }, 100);
      };
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { style: _this3.state, ref: _this3.state, key: i }));
      }, this);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-610636d0238213e301cd.js.map