...
throw new Error("Module build failed: SyntaxError: JSX attributes must only be assigned a non-empty expression (12:42)\n\n  10 |             this.props.content.split('\\\\n').map(function(line, key) {\n  11 |                 return (\n> 12 |                     <span key={key} style={}>\n     |                                           ^\n  13 |                         {line}\n  14 |                         <br/>\n  15 |                     </span>\n");
...
var NoteList = function (_React$Component) {
  ...
  function NoteList(props) {
    ...
    Object.defineProperty(_this, 'mouseOver', {
      enumerable: true,
      writable: true,
    ...
    Object.defineProperty(_this, 'mouseOut', {
      enumerable: true,
      writable: true,
      value: function value() {
  ...
  _createClass(NoteList, [{
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { children: notes, style: this.state, onMouseOver: this.mouseOver, onMouseOut: this.mouseOut });
    }
  }]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-52643079b7b6cecff0a8.js.map