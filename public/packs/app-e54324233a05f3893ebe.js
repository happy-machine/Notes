...
throw new Error("Module build failed: SyntaxError: Unexpected token (37:62)\n\n  35 |     shouldComponentUpdate = (nextProps, nextState)=> {\n  36 |         console.log('next',nextState)\n> 37 |         nextState.selected.value!=this.state.selected.value ? return true : return false\n     |                                                               ^\n  38 |         //return shallowCompare(this, nextProps, nextState);\n  39 |       }\n  40 |     render () {  \n");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_NoteWindow___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_NoteWindow__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-e54324233a05f3893ebe.js.map