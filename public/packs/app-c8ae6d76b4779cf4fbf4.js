    ...
    value: function componentDidMount() {
      ...
      function refresh() {
        ...
        setTimeout(function (props) {
          console.log('timeout', _this3);
          if (_this3.state.color != 'red') {
            var localOpacity = parseFloat(_this3.state.opacity);
            localOpacity += 0.01;
            _this3.state.opacity > 1.1 ? _this3.setState({ opacity: '0' }) : _this3.setState({ opacity: localOpacity.toString() });
          }
          _this3.refresh();
        }, 100);
      }
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-c8ae6d76b4779cf4fbf4.js.map