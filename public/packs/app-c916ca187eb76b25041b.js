  ...
  _createClass(NoteList, [{
    ...
    value: function render() {
      ...
      var notes = this.state.notes.map(function (contents, i) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__Note__["default"], _extends({}, contents, { style: _this3.state, key: i, ref: function ref(fieldEditor1) {
            _this3.fieldEditor1 = fieldEditor1;
          } }));
      }, this);
...
/***/ })
/******/ ]);
//# sourceMappingURL=app-c916ca187eb76b25041b.js.map